...
RSpec.describe MedicalRecordsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: medical_record.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      medical_record = MedicalRecord.create! valid_attributes
      get :edit, params: {id: medical_record.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new MedicalRecord" do
        expect {
          post :create, params: {medical_record: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {medical_record: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested medical_record" do
        medical_record = MedicalRecord.create! valid_attributes
        put :update, params: {id: medical_record.to_param, medical_record: new_attributes}, session: valid_session
      ...
      it "redirects to the medical_record" do
        medical_record = MedicalRecord.create! valid_attributes
        put :update, params: {id: medical_record.to_param, medical_record: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        medical_record = MedicalRecord.create! valid_attributes
        put :update, params: {id: medical_record.to_param, medical_record: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested medical_record" do
      medical_record = MedicalRecord.create! valid_attributes
      expect {
        delete :destroy, params: {id: medical_record.to_param}, session: valid_session
      }.to change(MedicalRecord, :count).by(-1)
    end
